                                ...
                                <div class="quantity">
                                    <div class="pro-qty">
                                        ...
                                        <asp:RegularExpressionValidator ID="revQuantity" runat="server" ErrorMessage="*" ForeColor="Red"
                                            ...
                                            Display="Dynamic" SetFocusOnError="false" EnableClientScript="true" ></asp:RegularExpressionValidator>
                                    </div>
                                </div>
                            </div>
                        </td>
                ...
                <FooterTemplate>
                    ...
                    <tr>
                        <td colspan="2" class="continue__btn">
                            <a href ="Menu.aspx" class="btn btn-info"> <i class="fa fa-arrow-circle-left mr-2"></i>Add more items</a>
                        </td>
                        <td>
                        ...
                        <td>
                            <asp:LinkButton ID="lbCheckout" runat="server" CommandName="checkout" CssClass="btn btn-success">
                               <i class="fa fa-arrow-circle-right mr-2"></i>Checkout
                                </asp:LinkButton>
                        </td>
                     </tr>
