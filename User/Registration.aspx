<%@ Page Title="" Language="C#" MasterPageFile="~/User/Home.Master" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="FoodDelivery.User.WebForm1" %>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form_container">
                        ...
                        <div>
                            <asp:RequiredFieldValidator ID="rfvAddress" runat="server" ErrorMessage="Address is required" ControlToValidate="txtName"
                                ForeColor="Red" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                        ...
                        <div>
                            <asp:RequiredFieldValidator ID="rfvPostCode" runat="server" ErrorMessage="Post Code/Zip Code is required" ControlToValidate="txtPostcode"
                                ForeColor="Red" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="revPostCode" runat="server" ErrorMessage="PostCode must have 6 digits"
                            ...
                            <asp:TextBox ID="txtPostCode" runat="server" CssClass="form-control" placeholder="Enter Post Code/Zip Code"
                                ToolTip="Post Code/Zip Code" TextMode="Number"></asp:TextBox>
                        </div>
                ...
                <div class="row pl-4">
                    <div class="btn_box">
                        ...
                        <asp:Label ID="lblAlreadyUser" runat="server" CssClass="pl-3 text-black-100"
                            Text="Already have an account? <a href='Login.aspx' class='badge badge-info'> Login </a>">
                        </asp:Label>
                     </div>
                </div>
